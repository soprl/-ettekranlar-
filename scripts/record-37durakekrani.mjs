#!/usr/bin/env node
/**
 * 37durakekrani.html yatay akıllı durak ekranını MP4 olarak kaydeder.
 * Kullanım: npm run record:37durakekrani
 * Önce: npm start
 */
...
const URL = 'http://127.0.0.1:3000/37durakekrani.html?record=1';
...
async function main() {
  ...
  const mp4Path = path.join(EXPORT_DIR, '37durakekrani.mp4');
