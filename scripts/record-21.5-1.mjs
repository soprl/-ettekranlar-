#!/usr/bin/env node
/**
 * arac-ici-aktarma.html (34E) → export/21.5-1.mp4
 * Kullanım: npm run record:21.5-1
 * Önce: npm start
 */
...
const URL = 'http://127.0.0.1:3000/arac-ici-aktarma.html';
/** 7 durak × 9 sn + pay */
const RECORD_SEC = Number(process.env.RECORD_SEC || 68);
...
async function main() {
  ...
  const mp4Path = path.join(EXPORT_DIR, '21.5-1.mp4');
