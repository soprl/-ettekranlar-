#!/usr/bin/env node
/**
 * 31.5.html (dikey İETT durak) animasyonunu MP4 olarak kaydeder.
 * Kullanım: npm run record:31.5
 * Önce: npm start
 */
...
const URL = 'http://127.0.0.1:3000/31.5.html?record=1';
/** Birkaç hat animasyonu + hava döngüsü */
...
async function main() {
  ...
  const mp4Path = path.join(EXPORT_DIR, '31.5.mp4');
