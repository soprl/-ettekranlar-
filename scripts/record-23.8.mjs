#!/usr/bin/env node
/**
 * 23.8.html animasyonunu MP4 olarak kaydeder.
 * Kullanım: npm run record:23.8
 * Önce: npm start
 */
...
const URL = 'http://127.0.0.1:3000/23.8.html';
/** 10 durak × 9 sn + pay */
...
async function main() {
  ...
  const mp4Path = path.join(EXPORT_DIR, '23.8.mp4');
