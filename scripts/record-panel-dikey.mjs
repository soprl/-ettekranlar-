#!/usr/bin/env node
/**
 * panel-dikey.html animasyonunu MP4 olarak kaydeder.
 * Kullanım: npm run record:panel-dikey
 * Önce: npm start
 */
...
const URL = 'http://127.0.0.1:3000/panel-dikey.html?record=1';
/** 5 haber × 7 sn */
const RECORD_SEC = Number(process.env.RECORD_SEC || 40);
...
async function main() {
  ...
  const mp4Path = path.join(EXPORT_DIR, 'panel-dikey.mp4');
