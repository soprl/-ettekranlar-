#!/usr/bin/env node
/**
 * metrobus-iett.html animasyonunu MP4 olarak kaydeder.
 * Kullanım: npm run record:metrobus-iett
 * Önce: npm start
 */
...
const URL = 'http://127.0.0.1:3000/metrobus-iett.html';
/** 10 durak tam tur (~45 sn) + pay */
const RECORD_SEC = Number(process.env.RECORD_SEC || 55);
...
async function main() {
  ...
  const mp4Path = path.join(EXPORT_DIR, 'metrobus-iett.mp4');
