#!/usr/bin/env node
/**
 * 06a.html (06A) animasyonunu MP4 olarak kaydeder.
 * Kullanım: npm run record:06a
 * Önce: npm start
 */
...
const URL = 'http://127.0.0.1:3000/06a.html';
/** 6 durak × 10 sn + pay */
...
async function main() {
  ...
  const mp4Path = path.join(EXPORT_DIR, '06a.mp4');
